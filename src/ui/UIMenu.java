...
public class UIMenu {
    ...
    private static void authUser(int userType){
        ...
        patients.add(new Patient("Jaime Potes", "jaime@mail"));
        patients.add(new Patient("Roberto Rodriguez", "roberto@mail"));
        patients.add(new Patient("Carlos Sánchez", "carlos@mail"));
